...
function Header({count}) {
    ...
    return(
        <header className="flex flex-row justify-between pt-5 pb-6 px-6 md:py-0 md:px-0 md:w-[77%] md:mx-auto md:gap-2 md:border-b-1 md:border-content-muted">
            ...
            <div className="flex flex-row gap-6 items-center relative xl:gap-12">
                <img src={shoppingCartIcon} alt="shopping cart icon" className="cursor-pointer w-full h-5"/>
                {count > 0 && (<span className="absolute top-0 leading-3 right-11 rounded-full w-5 h-3 text-[0.5rem] bg-brand-primary text-center text-white font-bold md:top-15 lg:w-6 lg:h-4 lg:text-[0.65rem] lg:leading-4 lg:top-14 lg:right-21">{count}</span>)}
